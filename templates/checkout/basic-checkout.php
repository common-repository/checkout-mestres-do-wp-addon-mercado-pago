...
<div class="mp-panel-checkout">
	...
	<div id="framePayments" class="mp-col-md-12">
		<div class="frame-tarjetas">
			<p class="mp-subtitle-basic-checkout">
				<?php echo esc_html_e( 'Credit cards' ); ?>
				<span class="mp-badge-checkout"><?php echo esc_html_e( 'Until' ); ?> <?php echo esc_html( $installments ); ?>
				<?php if ( '1' === $installments ) : ?>
					<?php echo esc_html_e( 'installment' ); ?>
				<?php else : ?>
					<?php echo esc_html_e( 'installments' ); ?>
				<?php endif; ?></span>
			</p>
	...
	<div id="framePayments" class="mp-col-md-6 mp-pr-15">
		<div class="frame-tarjetas">
			<p class="submp-title-checkout"><?php echo esc_html_e( 'Debit card' ); ?></p>
	...
	<div id="framePayments" class="mp-col-md-6">
		<div class="frame-tarjetas">
			<p class="submp-title-checkout"><?php echo esc_html_e( 'Payments in cash' ); ?></p>
	...
	<div class="mp-col-md-12 mp-pt-20">
		<div class="mp-redirect-frame">
			...
			<p><?php echo esc_html_e( 'We take you to our site to complete the payment' ); ?></p>
		</div>
	</div>
	<?php endif; ?>
